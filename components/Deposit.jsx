    ...
    return (
        <div className="w-full py-4 text-[white]">
            <div className="flex flex-col">
                <span className="text-[16px] text-[#b5b7da]">Deposit SOL to you Photon trading wallet.</span>
                <div className="flex flex-row mt-4 space-x-6">
                    ...
                    <div className="flex flex-col justify-between ">
                        <div className="flex flex-col space-y-2">
                            ...
                            <div
                                className="flex flex-row px-4 py-2 bg-transparent placeholder-[#b5b7da] border border-[#36363F] rounded-full w-36 hover:border-white focus:border-white"
                            >
                                {formatAddress('GgYUUUpzEPTtP9Q3F6teMEhhtTFvoASRXPuSfwKZanC9')}
                                <IoIosCopy className="self-center ml-1" style={{ width: '11px', height: '11px', color: '#b5b7da' }} />
                            </div>
                        </div>
                    </div>
                    <div className="flex flex-col">
                    ...
                    <div className="flex flex-col">
                        <div className="flex flex-row px-6 py-3 rounded-full mt-7" style={{color: 'black', backgroundColor: 'white'}}>
