              ...
              <table className="min-w-full" ref={tableRef}>
                <thead>
                  <tr>
                    ...
                    <th
                      scope="col"
                      className="px-4 py-3.5 text-left rtl:text-right font-semibold text-[#24252e] text-[14px] w-1/10"
                    >
                      asdfasdfa
                    </th>
                  </tr>
                ...
                <tbody className=" divide-y divide-[#36363F]">
                  {wallet ? (
                    <tr className="">
                      ...
                      <div
                        ...
                        className="flex justify-center bg-[#31323A] py-2"
                      >
                        Showing 4 transactions of maker {wallet}{" "}
                        <span
                          className="cursor-pointer text-[#8e9dff] ml-3"
                  ...
                  {MetaData.filter((val) => {
                    if (wallet === null) return val;
                    else if (wallet === val.makers) return val;
                  }).map((val, index) => (
                    <tr key={index}>
                      ...
                      <td className="px-4 py-4 whitespace-nowrap">
                        <div className="flex items-center">
                          ...
                          <div className="w-[60px] ml-2">
                            {val.dev === true ? (
                              <span className="text-[#e7b587] bg-[#303038] px-2 py-1 rounded-full text-[10px]">
                                Dev
                              </span>
                            ) : null}
                          </div>
                      ...
                      <td className="px-4 py-4 whitespace-nowrap ">
                        <div className="flex items-center justify-end ">
                          <img
                            ...
                            className="w-[20px] mr-1 fixed-size cursor-pointer"
                            src={"/images/Filter.svg"}
                          />
                          <img
                            className="w-[20px] mr-1 fixed-size cursor-pointer"
