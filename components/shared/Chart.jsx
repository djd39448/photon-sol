              ...
              <table className="min-w-full divide-y text-[13px]">
                ...
                <tbody>
                  {data.map((item, index) => (
                    ...
                    >
                      <td
                        className="inline-flex px-4 py-4 text-sm font-medium whitespace-nowrap"
                        style={{ width: "30%" }}
                      >
                        <div className="flex flex-row justify-between">
                          ...
                          <div className="ml-1" style={{ marginTop: "-2px" }}>
                            <div className="inline-flex items-center gap-x-1">
                              ...
                              <span className="text-[11px] text-[#b5b7da]">
                                SOL
                              </span>
                            </div>
                      ...
                      >
                        <div className="flex flex-col my-auto">
                          ...
                          <span className="text-[12px] text-[#b5b7da]">
                            {item.subcap}
                          </span>
                        </div>
                      </td>
                      ...
                      >
                        <div className="flex flex-col gap-1">
                          ...
                          <div className="flex flex-row space-x-1">
                            <span className="text-[12px] text-[#3ed6cc]">
                              {item.txns}
                            </span>
                            <span className="text-[12px]">/</span>
                            <span className="text-[12px] text-[#ff4b92]">
                              {item.txremain}
                            </span>
                          </div>
                        </div>
                      ...
                      >
                        <div className="flex flex-row space-x-5">
                          <div className="flex flex-col">
                            ...
                            <span className="text-[11px] mt-1">Mint Auth</span>
                            <span
                              className="text-[11px]"
                              style={{ marginTop: "-6px" }}
                            >
                          ...
                          <div className="flex flex-col">
                            ...
                            <span className="text-[11px] mt-1">Top 10</span>
                            <span
                              className="text-[11px]"
                              style={{ marginTop: "-6px" }}
                            >
                      ...
                      {status ? (
                        ...
                        >
                          <button
                            className="py-3 mx-auto rounded-full px-7"
                            style={{ backgroundColor: "rgb(39,39,46)" }}
                          >
