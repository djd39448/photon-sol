...
const DexesButton = () => {
  ...
  return (
    <div className="relative" ref={menuRef}>
      <button className="flex items-center px-3 py-2 space-x-2 text-white rounded-full hover:bg-gray-700 focus:outline-none" style={{border: '1px solid #333'}} onClick={handleToggle}>
