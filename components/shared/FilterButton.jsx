...
const FilterButton = () => {
  ...
  return (
    <div className="relative" ref={menuRef}>
      ...
      {isOpen && (
        <div className="absolute mt-1 w-80 bg-[#171821] rounded-lg shadow-lg z-10" style={{border: "1px solid #333"}}>
          <div className="px-6 py-4">
            <div className="flex flex-col space-y-2">
              ...
              <label className="flex items-center space-x-2 text-gray-300">
                <input 
                  ...
                  className="rounded-sm border-gray-600 text-[#6C61EB] checked:bg-[#6C61EB] focus:ring-0 focus:ring-offset-0" 
                />
                <span>Freeze Auth Disabled</span>
              </label>
              <label className="flex items-center space-x-2 text-gray-300">
                <input 
                  type="checkbox" 
              ...
              <label className="flex items-center space-x-2 text-gray-300">
                <input 
                  ...
                  className="rounded-sm border-gray-600 text-[#6C61EB] checked:bg-[#6C61EB] focus:ring-0 focus:ring-offset-0" 
                />
                <span>With at least 1 social</span>
              </label>
            </div>
            <div className="mt-4 text-[#b5b7da]">
              <div className="flex flex-col py-4" style={{borderTop: '1px solid #333'}}>
                <div className='mb-2'>
                    <span>By Current Liquidity($)</span>
                </div>
                <div className='flex flex-row justify-between mx-auto space-x-2'>
                    <input type="text" className="flex-1 px-3 py-1 lg:w-[120px] w-full bg-[#25262C] rounded-full text-gray-100" />
                    <span>to</span>
                    <input type="text" className="flex-1 px-3 py-1 lg:w-[120px] w-full bg-[#25262C] rounded-full text-gray-100" />
                </div>
              </div>
            ...
            <div className="flex flex-col py-4" style={{borderTop: '1px solid #333'}}>
                <div className="flex justify-between px-3">
                    <button className="px-4 py-2 text-sm rounded-full text-[#b5b7da]">Reset</button>
                    <button className="mr-3 px-6 py-2 text-sm bg-[#6C61EB] rounded-full text-white hover:bg-[#7069d6]">Apply</button>
                </div>
            </div>
        </div>
      )}
