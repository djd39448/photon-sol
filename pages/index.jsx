...
const NewPairs = () => {
  ...
  return (
    <div style={{ color: "white" }} className="px-4">
      ...
      <span className="text-[14px] text-[#b5b7da] px-2">
      ...
      <div className="flex flex-row flex-wrap justify-between px-2 mt-2">
        <div className="flex justify-between w-full lg:w-2/5 ">
          ...
          <button
            className={`ml-4 py-1 text-left px-4 border-2 rounded-full border-[#36363F] flex items-center ${
              !enabled ? "opacity-50" : ""
            }`}
            disabled={!enabled}
          >
        ...
        <div>
          <button
            className="flex flex-row items-center px-3 py-1 space-x-2 rounded-full"
